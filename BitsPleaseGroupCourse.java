...
public class BitsPleaseGroupCourse extends JFrame
{
   ...
   public BitsPleaseGroupCourse() throws IOException, SQLException
   {
      
      setTitle("Bits Please Gym MGMT System - Group Courses");
