...
public class BitsPleaseSpace extends JFrame
{
   ...
   public BitsPleaseSpace() throws IOException, SQLException 
   {
      
      setTitle("Bits Please Gym MGMT System - Reservable Space");
