...
public class BitsPleaseCourseReport extends JFrame
{
   ...
   public BitsPleaseCourseReport() throws IOException, SQLException
   {
      
      setTitle("Bits Please Gym MGMT System - Course Reports");
